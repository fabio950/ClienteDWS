 ...
 * @author alumno
 */
public class ClienteCategoriaTest {
    public static void main(String[] args) throws IOException {
        ...
        //Categoria p2 = addCategoria("http://localhost:8080/ProyectoFinal20162017-web/webservice/CategoriasService/Categorias/add", nuevaCategoria);
        ...
        System.out.println("Eliminamos una Categoría");
        System.out.println("---------------------------");
